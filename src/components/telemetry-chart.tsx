      ...
      <View style={styles.header}>
        ...
        <View style={styles.legend}>
          <View style={styles.legendItem}>
            ...
            <ThemedText type="code" style={styles.legendText}>X</ThemedText>
          </View>
          <View style={styles.legendItem}>
            <View style={[styles.dot, { backgroundColor: '#10B981' }]} />
            <ThemedText type="code" style={styles.legendText}>Y</ThemedText>
          </View>
          <View style={styles.legendItem}>
            <View style={[styles.dot, { backgroundColor: '#3B82F6' }]} />
            <ThemedText type="code" style={styles.legendText}>Z</ThemedText>
          </View>
        </View>
      </View>
