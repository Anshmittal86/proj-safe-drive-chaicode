  ...
  return (
    <View style={[styles.container, { width: size, height: size }]}>
      ...
      <View style={styles.textContainer}>
        <ThemedText style={{ fontSize: size * 0.24, fontWeight: '800' }}>
          {clampedScore}
        </ThemedText>
        <ThemedText type="small" themeColor="textSecondary" style={styles.maxText}>
          / 100
        </ThemedText>
        {showRatingLabel && (
          <ThemedText
            style={[
              styles.ratingText,
              { color: ratingColor, fontSize: size * 0.09, marginTop: 4 },
            ]}
          >
