...
export default function SummaryScreen() {
  ...
  const confirmDelete = () => {
    if (Platform.OS === 'web') {
      ...
      Alert.alert(
        'Delete Drive',
        'Are you sure you want to delete this trip log from history?',
        [
    ...
    >
      ...
      <View style={styles.header}>
        ...
        <ThemedText type="small" themeColor="textSecondary">
          Started at {formatTime(session.startTime)} • Total Duration: {formatDuration(session.duration)}
        </ThemedText>
      </View>
      ...
      <ThemedView type="backgroundElement" style={styles.scoreCard}>
        <View style={styles.scoreRow}>
          ...
          <View style={styles.scoreBreakdownCol}>
            <View style={styles.breakdownItem}>
              <ThemedText type="small" themeColor="textSecondary">TRIP RATING</ThemedText>
        ...
        <View style={styles.eventGrid}>
          <View style={styles.gridCell}>
            <ThemedText type="code" style={styles.cellCount}>{session.eventBreakdown.harsh_brake || 0}</ThemedText>
            <ThemedText type="small" themeColor="textSecondary">Harsh Brake</ThemedText>
          </View>
          <View style={styles.gridCell}>
            <ThemedText type="code" style={styles.cellCount}>{session.eventBreakdown.harsh_accel || 0}</ThemedText>
            <ThemedText type="small" themeColor="textSecondary">Harsh Accel</ThemedText>
          </View>
          <View style={styles.gridCell}>
            <ThemedText type="code" style={styles.cellCount}>{session.eventBreakdown.sharp_turn || 0}</ThemedText>
            <ThemedText type="small" themeColor="textSecondary">Sharp Turn</ThemedText>
          </View>
        </View>
        <View style={styles.eventGrid}>
          <View style={styles.gridCell}>
            <ThemedText type="code" style={styles.cellCount}>{session.eventBreakdown.aggressive_steer || 0}</ThemedText>
            <ThemedText type="small" themeColor="textSecondary">Agg. Steer</ThemedText>
          </View>
          <View style={styles.gridCell}>
            <ThemedText type="code" style={styles.cellCount}>{session.eventBreakdown.excessive_movement || 0}</ThemedText>
            <ThemedText type="small" themeColor="textSecondary">Device Move</ThemedText>
          </View>
          <View style={styles.gridCell}>
            <ThemedText type="code" style={styles.cellCount}>{session.eventBreakdown.phone_handling || 0}</ThemedText>
            <ThemedText type="small" themeColor="textSecondary">Phone Use</ThemedText>
          </View>
        </View>
      </ThemedView>
            ...
            {session.timeline.map((item, idx) => (
              <View key={item.id} style={styles.timelineItem}>
                ...
                <View style={styles.connectorCol}>
                  <View style={[styles.timelineDot, { backgroundColor: item.scoreImpact <= -10 ? theme.error : theme.warning }]} />
                  {idx < session.timeline.length - 1 && <View style={[styles.timelineLine, { backgroundColor: theme.border }]} />}
                </View>
                ...
                <ThemedView type="backgroundElement" style={styles.timelineCard}>
                  <View style={styles.timelineHeader}>
                    ...
                    <ThemedText type="bold" style={styles.impactText}>{item.scoreImpact} pts</ThemedText>
                  </View>
                  <View style={styles.timelineFooter}>
                    ...
                    <ThemedText type="small" themeColor="textSecondary">
                      Peak value: {item.magnitude} {item.type === 'phone_handling' ? '°' : item.type === 'excessive_movement' ? 'σ' : item.type.includes('turn') || item.type.includes('steer') ? 'rad/s' : 'm/s²'}
                    </ThemedText>
                  </View>
                </ThemedView>
              </View>
