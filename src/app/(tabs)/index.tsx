...
import { StyleSheet, ScrollView, View, Pressable, Platform, Dimensions } from 'react-native';
...
import { DriveSession, DriveEvent, RoutePoint, StorageService } from '../../services/storage-service';
...
export default function DriveScreen() {
  ...
  return (
    <View style={[styles.container, { backgroundColor: theme.background }]}>
      {!isDriving ? (
        /* ==================== RESTING DASHBOARD ==================== */
        <ScrollView contentContainerStyle={styles.restingContainer} contentInsetAdjustmentBehavior="automatic">
          {/* Welcome Card */}
          ...
          <ThemedView type="backgroundElement" style={styles.statsOverviewCard}>
            <View style={styles.statsCardGrid}>
              <View style={styles.statsCardCol}>
                ...
                <ThemedText style={[styles.statValue, { color: overallStats.averageScore >= 85 ? theme.success : theme.warning }]}>
          ...
          {!SensorService.getIsCalibrated() && (
            <ThemedView type="backgroundSelected" style={styles.alertBanner}>
              ...
              <ThemedText type="small" themeColor="textSecondary">
                Head to the Settings tab to calibrate your device's mounting angle for higher detection accuracy.
              </ThemedText>
            </ThemedView>
          )}
        ...
        >
          ...
          <View style={styles.hudStatsGrid}>
            <ThemedView type="backgroundElement" style={styles.hudStatBox}>
              ...
              <ThemedText type="bold" style={styles.hudStatVal}>{formatDuration(duration)}</ThemedText>
            </ThemedView>
            <ThemedView type="backgroundElement" style={styles.hudStatBox}>
              <ThemedText type="small" themeColor="textSecondary">SPEED</ThemedText>
              <ThemedText type="bold" style={styles.hudStatVal}>{speed} km/h</ThemedText>
            </ThemedView>
            <ThemedView type="backgroundElement" style={styles.hudStatBox}>
              <ThemedText type="small" themeColor="textSecondary">EVENTS</ThemedText>
              <ThemedText type="bold" style={styles.hudStatVal}>{totalEvents}</ThemedText>
            </ThemedView>
          </View>
