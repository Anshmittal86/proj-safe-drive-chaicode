...
import { SensorService, Thresholds } from '../../services/sensor-service';
...
export default function SettingsScreen() {
	...
	return (
		...
		>
			{/* Telemetry Visualizer Section - Collapsible */}
			<View style={styles.section}>
				...
				>
					...
					<ThemedText style={{ fontSize: 18, fontWeight: '600', marginRight: 4 }}>
						{showTelemetry ? '−' : '+'}
					</ThemedText>
				</Pressable>
				...
				{showTelemetry && (
					<>
						<ThemedText type="small" themeColor="textSecondary" style={styles.sectionDesc}>
							Real-time accelerometer data (m/s²). Move your device to see spikes.
						</ThemedText>
						...
						<ThemedView type="backgroundElement" style={styles.telemetryCard}>
							<View style={styles.telemetryRow}>
								...
								<ThemedText type="code" style={styles.valueText}>
									X: {rawSensorData.accel.x.toFixed(2)} Y: {rawSensorData.accel.y.toFixed(2)} Z:{' '}
									{rawSensorData.accel.z.toFixed(2)}
								</ThemedText>
							</View>
						</ThemedView>
					</>
			...
			<View style={styles.section}>
				...
				<ThemedText type="small" themeColor="textSecondary" style={styles.sectionDesc}>
					Establishes phone alignment inside the vehicle to accurately distinguish turns from
					braking.
				</ThemedText>
			...
			<View style={styles.section}>
				...
				<ThemedView type="backgroundElement" style={styles.thresholdControlCard}>
					...
					<View style={styles.adjusterRow}>
						<Pressable
							onPress={() => updateThreshold('braking', -0.2)}
				...
				<ThemedView type="backgroundElement" style={styles.thresholdControlCard}>
					...
					<View style={styles.adjusterRow}>
						<Pressable
							onPress={() => updateThreshold('acceleration', -0.2)}
							style={[styles.adjBtn, { borderColor: theme.border }]}
						>
							<ThemedText style={styles.adjText}>-</ThemedText>
						</Pressable>
				...
				<ThemedView type="backgroundElement" style={styles.thresholdControlCard}>
					...
					<View style={styles.adjusterRow}>
						<Pressable
							onPress={() => updateThreshold('turn', -0.05)}
							style={[styles.adjBtn, { borderColor: theme.border }]}
						>
							<ThemedText style={styles.adjText}>-</ThemedText>
						</Pressable>
				...
				<ThemedView type="backgroundElement" style={styles.thresholdControlCard}>
					...
					<View style={styles.adjusterRow}>
						<Pressable
							onPress={() => updateThreshold('phoneHandling', -1.0)}
							style={[styles.adjBtn, { borderColor: theme.border }]}
						>
							<ThemedText style={styles.adjText}>-</ThemedText>
						</Pressable>
			...
			<View style={styles.section}>
				...
				<ThemedText type="small" themeColor="textSecondary" style={styles.sectionDesc}>
					Simulate standard driving trips to review event triggers, live score dials, and summaries
					in the simulator.
				</ThemedText>
					...
					<Pressable
						...
						style={[
							styles.profileBtn,
							{
								borderColor: theme.border,
								backgroundColor:
									simProfile === 'distracted' ? theme.backgroundSelected : 'transparent'
							}
						]}
					>
				...
				<Pressable onPress={startSim} style={[styles.simButton, { backgroundColor: theme.accent }]}>
